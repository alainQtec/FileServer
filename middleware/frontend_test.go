...
import (
	"errors"
	"github.com/alainQtec/FileServer/v3/bootstrap"
...
func TestFrontendFileHandler(t *testing.T) {
	...
	// 成功且命中
	{
		...
		cache.Set("setting_siteKeywords", "FileServer", 0)
		cache.Set("setting_siteScript", "FileServer", 0)
		cache.Set("setting_pwa_small_icon", "FileServer", 0)
