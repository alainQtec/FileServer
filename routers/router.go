...
import (
	"github.com/alainQtec/FileServer/v3/middleware"
	...
	"github.com/alainQtec/FileServer/v3/pkg/hashid"
	"github.com/alainQtec/FileServer/v3/pkg/util"
	wopi2 "github.com/alainQtec/FileServer/v3/pkg/wopi"
	"github.com/alainQtec/FileServer/v3/routers/controllers"
...
func InitCORS(router *gin.Engine) {
	...
	if conf.SystemConfig.Mode == "slave" {
		util.Log().Warning("You are running FileServer as slave node, if you are using slave storage policy, please enable CORS feature in config file, otherwise file cannot be uploaded from Master site.")
	}
}
